...
?></td>
	...
	<td><?php echo mysql_result($query,$i,company_name);?></td>
	<td><?php echo mysql_result($query,$i,z1);?></td>
	<td><?php echo mysql_result($query,$i,z1_weight);?></td>
	<td><?php echo mysql_result($query,$i,z2);?></td>
	<td><?php echo mysql_result($query,$i,z2_weight);?></td>
	<td><?php echo mysql_result($query,$i,z3);?></td>
	<td><?php echo mysql_result($query,$i,z3_weight);?></td>
	<td><?php echo mysql_result($query,$i,z4);?></td>
	<td><?php echo mysql_result($query,$i,z4_weight);?></td>
	<td><?php echo mysql_result($query,$i,z5);?></td>
	<td><?php echo mysql_result($query,$i,z5_weight);?></td>
	<td><?php echo mysql_result($query,$i,z6);?></td>
	<td><?php echo mysql_result($query,$i,z6_weight);?></td>
	<td><?php echo mysql_result($query,$i,z7);?></td>
	<td><?php echo mysql_result($query,$i,z7_weight);?></td>
